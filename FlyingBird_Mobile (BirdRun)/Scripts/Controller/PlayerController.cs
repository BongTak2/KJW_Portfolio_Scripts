...
public class PlayerController : MonoBehaviour
{
    ...
    [SerializeField] public GameObject skill_4;
    [SerializeField] private GameObject skillEffector;

    [Header("Audio")]
    [SerializeField] private AudioClip[] skillAudios;
    ...
    private const float riseValue = 14f;
    ...
    [SerializeField] private Sprite back, front;
    ...
    void Update()
    {
        ...
        if (IsMoving)
        {
            ...
            else
            {
                ...
                if (Time.timeScale == 1)
                {
                    if (GameManager.instance.inputKey[ButtonType.Skill])
    ...
    private void MovePlayer()
    {
        ...
        if (GameManager.instance.inputKey[ButtonType.Rise])
        ...
        {
            currentVelocity.y = -7f;
            animator.SetBool("Rise", false);
        }

        // 현재속도가 0보다 작을 때는 부스터 작동 X
        if (GameManager.instance.inputKey[ButtonType.Boost])
